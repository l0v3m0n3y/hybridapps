class hybridapps{
    constructor(){
        this.api = "https://hybridapps.net/apps"
    ...
    async short_url(url){
        let req=await fetch(`${this.api}/URLShortner/qrcode.php?url=${url}`,{method:"GET",headers: this.headers});
        return await req.json();
    }
}
module.exports = {hybridapps};